...
| 参数名            | 必填 | 描述                                                                                                                                                                                                                                                                                                                                                                        |
|----------------|----|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| shoprs         | 可选 | 本参数定义一个包含查询及搜索过滤器相关metadata的token。<br>⚠️"q"参数与"shoprs"并不是必须同时使用。<br>如果要应用多个过滤器，可以使用&#124;&#124;连接，比如 shoprs_1&#124;&#124;shoprs_2&#124;&#124;shoprs_3。<br>该参数的可用值无法通过 Google Shopping Light API 获取。<br>你可以使用我们的 [Google Shopping API](https://serpapi.com/google-shopping-api) 来获取这些值，<br>或者直接访问 Google Shopping 网站，设置你需要的过滤条件，然后将其 URL 中的 shoprs 值复制到 SerpApi 的 URL 中即可。 |
